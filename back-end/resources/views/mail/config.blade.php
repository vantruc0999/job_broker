...
<form action="/test-mail" method="post">
    ...
    <input type="text" name="username" value="vantruc0409@gmail.com" placeholder="Username"><br>
    <input type="text" name="password" value="cfjuktvsftwuhmbo" placeholder="Password"><br>
